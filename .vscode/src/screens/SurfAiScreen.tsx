...
export default function SurfAiScreen() {
  const router = useRouter();
  ...
  // Surf AI items
  const surfAiItems: SettingsRow[] = [
    { 
      title: 'Surf AI Settings', 
      icon: 'cpu', 
      onPress: () => Alert.alert('Coming Soon', 'Surf AI Settings will be available soon!')
    },
  ];
