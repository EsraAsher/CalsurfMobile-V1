// src/screens/HealthGoalsScreen.tsx
...
export default function HealthGoalsScreen() {
  ...
  // Health goals items
  const healthGoalsItems: SettingsRow[] = [
    { title: 'Calorie Goal', icon: 'activity', route: '/settings/goals' },
    { title: 'Protein Goal', icon: 'target', route: '/settings/goals' },
    { title: 'Body Measurements', icon: 'trending-up', route: '/settings/goals' },
  ];
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        {/* Health Goals List */}
        {healthGoalsItems.map((item, index) => (
          <SettingsRowItem 
            key={item.title} 
            item={item} 
            colors={colors}
